// Convert 2 local mountain photos (Haba Snow, Wuyi) to optimized WebP (replace existing main images).
// Usage: node scripts/convert-local2b.mjs
...
const JOBS = [
  { src: "C:/Users/nec10/Downloads/网站图/哈巴雪山.png", dest: "haba-snow.webp" },
  { src: "C:/Users/nec10/Downloads/网站图/武夷山.png", dest: "wuyi.webp" },
];
